...
const char* wifi_reason_to_string(wifi_err_reason_t reason)
{
    ...
    case WIFI_REASON_DISASSOC_DUE_TO_INACTIVITY: return "WIFI_REASON_DISASSOC_DUE_TO_INACTIVITY";
    case WIFI_REASON_ASSOC_TOOMANY: return "WIFI_REASON_ASSOC_TOOMANY";
    case WIFI_REASON_CLASS2_FRAME_FROM_NONAUTH_STA: return "WIFI_REASON_CLASS2_FRAME_FROM_NONAUTH_STA";
    case WIFI_REASON_CLASS3_FRAME_FROM_NONASSOC_STA: return "WIFI_REASON_CLASS3_FRAME_FROM_NONASSOC_STA";
    ...
    default: {
        static char buf[32];
        snprintf(buf, sizeof(buf), "UNKNOWN(%d)", (int)reason);
        return buf;
    }
    }
}
